...
public class DataHandler {
  ...
  public void setDirectionalFilters(List<DirectionalFilter> directionalFilters) { this.directionalFilters = new ArrayList<>(directionalFilters); }

  public void setKeyObjectsToFilterOn(List<BaseDependencyObject> keyObjects) { this.keyObjects = new TreeSet<>(keyObjects); }

  public void setTypesFilters(List<Ranking> typesFilters) { this.typesFilters = new ArrayList<>(typesFilters); }

  public void saveDataset() { dataFileWriter.saveToFile(this); }
}
