...
public class DependencyDataSet extends BaseDependencyDataSet {
  ...
  @Override
  public Stream<BaseDependencyObject> getObjects() { return objectsMap.values().stream()
                                                                      .map(d -> (BaseDependencyObject) d); }

  @Override
  public BaseDependencyObject get(String key) { return objectsMap.get(key); }

  @Override
  public boolean containsKey(String key) { return objectsMap.containsKey(key); }
