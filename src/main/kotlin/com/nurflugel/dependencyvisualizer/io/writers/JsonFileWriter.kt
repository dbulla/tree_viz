...
public class JsonFileWriter extends DataFileWriter {
  ...
  public void saveToFile(DataHandler dataHandler) {
    BaseDependencyDataSet dataSet = dataHandler != null ? dataHandler.getDataset() : null;

    dataSet.generateRankingsMap();

    String fileName  = super.getSourceDataFile().getAbsolutePath();
    ...
    File file = new File(getSourceDataFile().getParent(), fileName);
